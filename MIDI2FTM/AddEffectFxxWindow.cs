...
namespace MIDI2FTM
{
    ...
    /// EffectFxxを追加するウィンドウ
    /// </summary>----------------------------------------------------------------------------------------------------
    public partial class AddEffectFxxWindow : Form
    {
        ...
        /// コンストラクタ♪
        /// </summary>----------------------------------------------------------------------------------------------------
        public AddEffectFxxWindow(ref string[] _channelList, ref byte[] _channeEffectCount)
        {
            InitializeComponent();
        ...
        {
            // Fxxを出力するチャンネルを設定
            ChannelConfigState.OutPutEffectFxxChannel = (byte)TrackerChannelList.SelectedIndex;
            // 閉じる
            Close();
        }
        ...
        {
            // Fxxを出力するチャンネルを無効化
            ChannelConfigState.OutPutEffectFxxChannel = 255;
            // 閉じる
            Close();
        }
    }
